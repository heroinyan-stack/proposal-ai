...
const posts = [
  {
    ...
    excerpt:
      "Are your Upwork proposals getting ignored? Discover the 10 most common mistakes freelancers make and how to fix them to dramatically increase your win rate.",
    readTime: "11 min",
    category: "Guides",
  },
  {
