...
const posts = [
  {
    ...
    excerpt:
      "Avoid these 10 common Upwork proposal mistakes that silently kill your response rate. Learn what top-rated freelancers do differently to win more contracts.",
    readTime: "11 min",
    category: "Guides",
  },
  {
