...
const posts = [
  {
    ...
    excerpt:
      "Avoid these common Upwork proposal mistakes that silently kill your win rate. Learn what top-rated freelancers never do and how to write proposals that get responses.",
    readTime: "11 min",
    category: "Guides",
  },
  {
