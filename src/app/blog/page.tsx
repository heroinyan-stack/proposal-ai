...
const posts = [
  {
    ...
    excerpt:
      "Discover the top 10 Upwork proposal mistakes that are costing you jobs. Learn what to avoid and how to write proposals that actually get clients to respond.",
    readTime: "12 min",
    category: "Mistakes",
  },
  {
